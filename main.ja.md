...
本解説書は、英語原稿 “Future Determination Bias as Emergent Gravity...” を基に、将来決定バイアス (Future Determination Bias; FDB) の発想と検証手続きを日本語で体系化したものである。重力理論・電磁気学・統計物理の基礎を修めた読者を想定し、以下の順序で議論を進める。
...
その後、Proca 電磁場・導波路・情報流束・観測検証・再現性という詳細論を展開する。GitHub (<https://github.com/genki/gravitation>) の `make` コマンドで英語版 (build/main.pdf) と日本語版 (build/main.ja.pdf) を同時生成できる。

---

## 1. 観点の再整理 — GR と FDB を併存させるために
